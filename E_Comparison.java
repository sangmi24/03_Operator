...
public class E_Comparison {
	 ...
	 * 비교 연산 결과가 참일경우 true, 거짓일 경우 false값을 반환 
	 ...
	 * 
	 * 2. 일치함을 비교 => 숫자 뿐만이 아니라, 문자 , 주소값, 논리값 등
	 * a == b : a와 b 가 일치합니까?
	 * a != b : a와 b 가 일치하지 않습니까? 
	 */
	...
	public void method1 ( ) {
		...
		//동등비교 연산자
		boolean result1 = (a == b); //가독성을 위해  ( )사용
		...
		/*
		 * 짝수, 홀수
		 * 짝수 : 2로 나누었을때 나누어 떨어지는 수 = 나머지값이 0이다. 
		 * 홀수 : 2로 나누었을때 나누어 떨어지지 않는 수  =나머지값이 1이다.
		 * => 어떤 값을 2로 나누었을때 나머지 값이 0이냐 , 1이냐를 가지고
		 *    짝수인지 홀수인지 판별 가능    
		 */
	    ...
	    //말장난
	    System.out.println("a가 홀수입니까? "+ ((a % 2) == 1 ));  //홀수
	    System.out.println("a가 짝수가 아닙니까? :" +((a % 2) != 0)); //홀수
	    
	    System.out.println("a가 홀수가 아닙니까? :"+ ((a % 2) != 1));  //짝수
